...
// Use d3 to update each cell's text with UFO key/value pairs (Date, city, state, country, shape, duration, comments)
...
// Use D3 to select the Date Time input field and the Filter button (id = #; class = .)
